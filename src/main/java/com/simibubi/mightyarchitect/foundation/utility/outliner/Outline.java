...
public abstract class Outline {
	...
	public void renderCuboidLine(MatrixStack ms, IRenderTypeBuffer buffer, Vec3d start, Vec3d end) {
	...
	public void putQuadUVColor(MatrixStack ms, IVertexBuilder builder, Vec3d v1, Vec3d v2, Vec3d v3, Vec3d v4, Vec3d rgb, float minU,
	...
	protected void putVertex(MatrixStack ms, IVertexBuilder builder, Vec3d pos, Vec3d rgb, float u, float v, Direction normal) {
		int i = 15 << 20 | 15 << 4;
		int j = i >> 16 & '\uffff';
		int k = i & '\uffff';
		Entry peek = ms.peek();
