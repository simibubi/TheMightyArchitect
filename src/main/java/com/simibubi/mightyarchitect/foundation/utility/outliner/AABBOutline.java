...
public class AABBOutline extends Outline {
	...
	protected void renderBoxFaces(PoseStack ms, MultiBufferSource buffer, boolean cull, Direction highlightedFace, Vector3f minPos, Vector3f maxPos, Vector4f color, int lightmap) {
	...
	protected void renderBoxFace(PoseStack.Pose pose, MultiBufferSource buffer, boolean cull, Direction highlightedFace, Vector3f minPos, Vector3f maxPos, Direction face, Vector4f color, int lightmap) {
